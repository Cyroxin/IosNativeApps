...
extension UIView
{
    @objc func dismissToast(_ sender: UITapGestureRecognizer? = nil)
    {
    ...
    func showToast(toastMessage:String)
    {
        ...
        bgView.backgroundColor = UIColor(red: CGFloat(255.0/255.0), green: CGFloat(255.0/255.0), blue: CGFloat(255.0/255.0), alpha: CGFloat(0.5))
        bgView.tag = 555
        
        let gesture = UITapGestureRecognizer(target: bgView, action: #selector(self.dismissToast(_:)))
        ...
        lblMessage.backgroundColor = .systemTeal
